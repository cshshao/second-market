...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, '超级管理员', 13288888888, '111111', '超级管理员');
...
CREATE TABLE `catelog`  (
  ...
  `number` int NULL DEFAULT 0 COMMENT '该分类下的商品数量',
  `status` tinyint NULL DEFAULT 0 COMMENT '分类状态，0正常，1暂用',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `comments`  (
  ...
  `user_id` int NULL DEFAULT NULL COMMENT '用户，外键',
  `goods_id` int NULL DEFAULT NULL COMMENT '商品，外键',
...
INSERT INTO `comments` VALUES (130, 27, 117, '阿斯蒂芬', '2021-03-13 04:56:34');
INSERT INTO `comments` VALUES (131, 27, 127, '线下成交吧', '2021-03-13 09:14:21');
INSERT INTO `comments` VALUES (132, 27, 109, '线下成交吧', '2021-03-14 02:09:46');
INSERT INTO `comments` VALUES (134, 28, 116, '你好，什么时候有时间进行线下交易', '2021-05-16 11:34:14');
INSERT INTO `comments` VALUES (137, 28, 131, '3', '2021-05-18 09:15:26');
...
CREATE TABLE `focus`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `goods_id` int NULL DEFAULT NULL COMMENT '外键 商品id',
  `user_id` int NULL DEFAULT NULL COMMENT '外键 用户id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `goods`  (
  ...
  `catelog_id` int NULL DEFAULT NULL COMMENT '商品分类，外键',
  `user_id` int NULL DEFAULT NULL COMMENT '用户外键',
  ...
  `status` int NULL DEFAULT 1 COMMENT '状态 上架1 下架0',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `goods` VALUES (106, 5, 23, '资生堂金瓶防晒霜', 50.00, 260.00, '2018-05-07', '2018-05-18', '2018-05-17', '夏天必不可少的一款防晒霜，真的晒不黑哦。', 0);
INSERT INTO `goods` VALUES (107, 5, 23, '露得清防晒喷雾', 40.00, 110.00, '2018-05-07', '2018-05-07', '2018-05-17', '很方便的防晒喷雾，可以随身携带，随时喷一喷。而且这款喷雾很清爽，一点也不油腻。', 0);
INSERT INTO `goods` VALUES (108, 5, 23, '太阳镜', 10.00, 30.00, '2018-05-07', '2018-05-07', '2018-05-17', '可以用来遮阳的', 0);
...
INSERT INTO `goods` VALUES (116, 4, 25, '自习神器', 216.00, 2222.00, '2019-03-21', '2019-03-21', '2019-03-31', '跟女朋友一起自习的神器！', 1);
INSERT INTO `goods` VALUES (119, 1, 27, '', 123.00, 312.00, '2021-03-13', '2021-03-13', '2021-03-23', '12323', 0);
INSERT INTO `goods` VALUES (120, 4, 27, '测试物品发布', 432.00, 1243.00, '2021-03-13', '2021-03-13', '2021-03-23', '测试物品发布 商品描述', 0);
INSERT INTO `goods` VALUES (121, 1, 27, 'video', 12.00, 50.00, '2021-03-13', '2021-03-13', '2021-03-23', 'video test', 0);
INSERT INTO `goods` VALUES (122, 1, 27, '', NULL, NULL, '2021-03-13', '2021-03-13', '2021-03-23', '', 0);
INSERT INTO `goods` VALUES (123, 4, 27, 'Think in java', 43.00, 120.00, '2021-03-13', '2021-03-13', '2021-03-23', 'think in java', 0);
INSERT INTO `goods` VALUES (124, 4, 27, 'Think in java', 43.00, 120.00, '2021-03-13', '2021-03-13', '2021-03-23', 'think in java', 0);
INSERT INTO `goods` VALUES (125, 4, 27, 'Think in java', 43.00, 120.00, '2021-03-13', '2021-03-13', '2021-03-23', 'think in java', 0);
INSERT INTO `goods` VALUES (126, 4, 27, 'Think in java', 43.00, 120.00, '2021-03-13', '2021-03-13', '2021-03-23', 'think in java', 0);
INSERT INTO `goods` VALUES (127, 1, 27, 'aaa', 13.00, 65.00, NULL, '2021-03-15', NULL, 'abook', 0);
INSERT INTO `goods` VALUES (128, 4, 27, 'think in java', 32.00, 210.00, '2021-03-13', '2021-03-13', '2021-03-23', 'think in java', 0);
INSERT INTO `goods` VALUES (129, 1, 27, 'test', 123.00, 321.00, NULL, '2021-03-14', NULL, '修改', 0);
INSERT INTO `goods` VALUES (140, 1, 27, '哈哈哈', 499.00, 999.00, '2021-05-24', '2021-05-24', '2021-06-03', '', 1);
INSERT INTO `goods` VALUES (141, 1, 27, '照相机', 34.00, 99.00, '2021-05-24', '2021-05-24', '2021-06-03', '哈哈哈', 1);
INSERT INTO `goods` VALUES (142, 7, 27, '图片', 0.99, 0.99, '2021-05-24', '2021-05-24', '2021-06-03', '', 1);
...
CREATE TABLE `image`  (
  ...
  `img_url` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '图片链接',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `image` VALUES (119, 119, 'a710b12f-1b85-45f0-b037-22d0b10dc09d.png');
INSERT INTO `image` VALUES (120, 120, 'e00375b5-082e-46bf-90f8-b0332439c2bf.png');
INSERT INTO `image` VALUES (121, 121, '1a3f7f7a-9064-403a-bf56-4afee6801179.png');
INSERT INTO `image` VALUES (136, 140, 'f4efcd11-a4b9-4b89-8b92-ccd28cb62ac5.jpg');
INSERT INTO `image` VALUES (137, 141, 'd6711c38-28ec-4051-aab0-f87c7f0a8268.jpg');
INSERT INTO `image` VALUES (138, 142, 'c89bd35a-ff06-44a1-9000-cf6c6880fa29.jpg');
...
CREATE TABLE `notice`  (
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '状态，0未读，1已读',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `notice` VALUES (18, 27, '跪求辅导资料', '2021-03-13 15:25:43', 0);
...
CREATE TABLE `orders`  (
  ...
  `order_num` bigint NULL DEFAULT NULL COMMENT '订单编号',
  `order_price` float(11, 0) NULL DEFAULT NULL COMMENT '订单价格',
  `order_state` int NULL DEFAULT 1 COMMENT '订单状态 1待发货 2待收货 3已完成',
...
INSERT INTO `orders` VALUES (8, 26, 116, 11362720, 216, 2, '试试看', '2019-03-21 04:43:21');
...
INSERT INTO `orders` VALUES (11, 27, 106, 88257107, 50, 1, '', '2021-03-13 04:59:06');
...
CREATE TABLE `purse`  (
  ...
  `state` int NULL DEFAULT NULL COMMENT '状态 0未审核   已审核（1不通过 2通过）',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `purse` VALUES (22, 27, 00000000250, NULL, NULL, NULL);
...
CREATE TABLE `reply`  (
  ...
  `commet_id` int NULL DEFAULT NULL COMMENT '评论，外键',
...
CREATE TABLE `user`  (
  ...
  `goods_num` int NULL DEFAULT 0 COMMENT '发布过的物品数量',
  ...
  `status` tinyint NULL DEFAULT 0 COMMENT '账号是否冻结，默认0未冻结',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (27, '13120111111', 'test', '098F6BCD4621D373CADE4E832627B4F6', NULL, '2021-03-13 15:22', -1, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (28, '15188571996', '葛佩佩', '26ECB9EE721C52B7D791AD9F326DA9C4', '2370527723', '2021-05-15 18:47', 2, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (29, '17803858676', '15188571996', 'FA1755F14893E187C82913DC5030261B', NULL, '2021-05-16 00:11', 0, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (30, '19103850127', '葛佩佩', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, '2021-05-16 10:58', 0, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (31, '15137649965', '葛佩佩', 'FA1755F14893E187C82913DC5030261B', NULL, '2021-05-16 11:01', 0, 0000000100, NULL, 1);
